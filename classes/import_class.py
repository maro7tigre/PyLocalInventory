...
class ImportClass(BaseClass):
    def __init__(self, id, database, supplier_id, product_id):
        super().__init__(id, database)
        self.section = "Imports"
        self.parameters = {
            "supplier_id": {"value": supplier_id, "display name": {"en": "supplier", "fr": "fournisseur", "es": "proveedor"}, "required": True, "default": 0, "options": [], "type": "int"},
        ...
        self.available_parameters = {
            "table": ["supplier_id", "product_id", "quantity", "unit price", "tva", "total price", "date"],
            "dialog": ["supplier_id", "product_id", "quantity", "unit price", "tva", "total price", "date", "notes"],
            "database": ["supplier_id", "product_id", "quantity", "unit price", "tva", "total price", "date", "notes"],
            "report": ["supplier_id", "product_id", "quantity", "unit price", "tva", "total price", "date"]
        }
